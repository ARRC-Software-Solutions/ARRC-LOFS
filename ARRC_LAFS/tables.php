...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2 align="center">Generate PDF file from MySQL Using PHP</h2>
            <form class="form-inline" method="post" action="generate_pdf.php">
            <button style="margin-left:auto;margin-right:auto; margin-top:10%" type="submit" id="pdf" name="generate_pdf" class="btn btn-primary"><i class="fa fa-pdf" aria-hidden="true"></i>
            Generate PDF</button>
            </form>
            </fieldset>
